...
![LTER researcher releasing a pika at the Niwot site, LTER CC BY-SA 4.0](nwt_pikas_img.jpg)
...
```{r}
#creates a vector that is based on a for loop that iritates the amount of times there are rows in bill_length_mm
